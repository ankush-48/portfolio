...
import { ArrowUpRight, Award, Briefcase, Check, Code2, Download, FolderGit2, Github, GraduationCap, Linkedin, Mail, MapPin, Moon, Palette, Rocket, Sparkles, Sun, Trophy, User, Wrench } from "lucide-react";
...
function ThemeSwitcher() {
	...
	return /* @__PURE__ */ jsxs(Popover, { children: [/* @__PURE__ */ jsx(PopoverTrigger, {
		...
		children: /* @__PURE__ */ jsxs(Button, {
			...
			children: [/* @__PURE__ */ jsx(Palette, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", { children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: ACCENTS.map((a) => /* @__PURE__ */ jsx("button", {
						...
						children: accent === a.id && /* @__PURE__ */ jsx(Check, {
				...
				children: [/* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(Moon, { className: "h-4 w-4" }), " Dark"]
					...
					children: [/* @__PURE__ */ jsx(Sun, { className: "h-4 w-4" }), " Light"]
				})]
			})] })]
		})
	})] });
...
//#endregion
//#region src/components/live-background.tsx
var BUBBLES = [
	{
		size: 420,
		top: "6%",
...
function LiveBackground() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			BUBBLES.map((b, i) => /* @__PURE__ */ jsx(motion.span, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(ThemeSwitcher, {})
				})
			]
		})
	});
		...
		children: /* @__PURE__ */ jsxs(motion.div, {
			...
			children: [
				/* @__PURE__ */ jsxs(Badge, {
					...
					children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }), "Open to Full-Time Software Engineering Opportunities"]
				}),
				/* @__PURE__ */ jsxs("h1", {
					...
					children: [
						...
						/* @__PURE__ */ jsx(Button, {
							...
							children: /* @__PURE__ */ jsxs("a", {
								...
								target: "_blank",
								rel: "noreferrer",
								children: [/* @__PURE__ */ jsx(Linkedin, { className: "mr-2 h-4 w-4" }), "LinkedIn"]
							})
						}),
						/* @__PURE__ */ jsx(Button, {
							asChild: true,
							...
							children: /* @__PURE__ */ jsxs("a", {
								...
								target: "_blank",
								rel: "noreferrer",
								children: [/* @__PURE__ */ jsx(Github, { className: "mr-2 h-4 w-4" }), "GitHub"]
							})
						})
					]
				}),
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsx(motion.div, {
			...
			children: /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Icon, { className: "h-3.5 w-3.5" }), eyebrow]
			}), /* @__PURE__ */ jsx("h2", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("p", { children: "My interests include Generative AI, Retrieval-Augmented Generation (RAG), Machine Learning, DevOps, and Cloud Technologies. I enjoy transforming ideas into practical applications and continuously improving my technical skills through hands-on projects." })
				]
			}), /* @__PURE__ */ jsxs(Card, {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: [
						/* @__PURE__ */ jsxs("li", {
							...
							children: [/* @__PURE__ */ jsx(Rocket, { className: "mt-0.5 h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Seeking Full-Time Software Engineer opportunities" })]
						}),
						/* @__PURE__ */ jsxs("li", {
							className: "flex items-start gap-3",
							children: [/* @__PURE__ */ jsx(Code2, { className: "mt-0.5 h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Building AI, Cloud & Full-Stack Development projects" })]
						}),
						/* @__PURE__ */ jsxs("li", {
							className: "flex items-start gap-3",
							children: [/* @__PURE__ */ jsx(MapPin, { className: "mt-0.5 h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("span", { children: "Bengaluru, Karnataka, India" })]
						})
					]
				})]
			})]
...
function Skills() {
	return /* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: SKILLS.map((group) => /* @__PURE__ */ jsxs(Card, {
				...
				children: [/* @__PURE__ */ jsx("h3", {
					...
					children: group.items.map((item) => /* @__PURE__ */ jsx(Badge, {
						variant: "secondary",
...
function Experience() {
	return /* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsx("ol", {
			...
			children: EXPERIENCE.map((job, i) => /* @__PURE__ */ jsxs(motion.li, {
				initial: {
					opacity: 0,
					x: -12
				},
				...
				className: "relative",
				children: [
					/* @__PURE__ */ jsx("span", { className: "absolute -left-[37px] top-2 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-primary ring-4 ring-background" }),
					/* @__PURE__ */ jsxs("div", {
					...
					/* @__PURE__ */ jsx("ul", {
						...
						children: job.points.map((p) => /* @__PURE__ */ jsx("li", {
...
function Projects() {
	return /* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: PROJECTS.map((p, i) => /* @__PURE__ */ jsxs(motion.a, {
				href: p.href,
				initial: {
					opacity: 0,
					y: 16
				...
				children: [/* @__PURE__ */ jsx("div", { className: "absolute -right-16 -top-16 h-40 w-40 rounded-full bg-primary/15 blur-3xl transition-opacity group-hover:opacity-100" }), /* @__PURE__ */ jsxs("div", {
					className: "relative",
					children: [
						/* @__PURE__ */ jsxs("div", {
...
function Achievements() {
	return /* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsx("div", {
			className: "grid gap-4 sm:grid-cols-2",
			children: ACHIEVEMENTS.map((a) => /* @__PURE__ */ jsxs(Card, {
...
function Education() {
	return /* @__PURE__ */ jsx(Section, {
		...
		children: /* @__PURE__ */ jsx("div", {
			className: "grid gap-5 md:grid-cols-2",
			children: EDUCATION.map((e) => /* @__PURE__ */ jsxs(Card, {
				className: "border-border/60 bg-card/60 p-6 backdrop-blur",
				children: [
					/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsx(Button, {
							...
							children: /* @__PURE__ */ jsxs("a", {
								...
								target: "_blank",
								rel: "noreferrer",
								children: [/* @__PURE__ */ jsx(Mail, { className: "mr-2 h-4 w-4" }), "Email Me"]
							})
						}),
						/* @__PURE__ */ jsx(Button, {
							asChild: true,
							...
							children: /* @__PURE__ */ jsxs("a", {
								href: "/Resume_SE.pdf",
								download: true,
								children: [/* @__PURE__ */ jsx(Download, { className: "mr-2 h-4 w-4" }), "Resume (Software Engineer)"]
							})
						}),
						/* @__PURE__ */ jsx(Button, {
							asChild: true,
							...
							children: /* @__PURE__ */ jsxs("a", {
								...
								download: true,
								children: [/* @__PURE__ */ jsx(Download, { className: "mr-2 h-4 w-4" }), "Resume (AI / ML & Data Science)"]
							})
						}),
						/* @__PURE__ */ jsxs("div", {
